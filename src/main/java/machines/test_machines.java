...
@Deprecated
public class test_machines extends
    GT_MetaTileEntity_ExtendedPowerMultiBlockBase<test_machines> implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<test_machines> STRUCTURE_DEFINITION = StructureDefinition
        .<test_machines>builder()
        .addShape(
        ...
        .addElement(
            ...
            ofChain(
                lazy(
                    t -> GT_StructureUtility.<test_machines>buildHatchAdder()
    ...
    public test_machines(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public test_machines(String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new test_machines(this.mName);
    }
    ...
    @Override
    public IStructureDefinition<test_machines> getStructureDefinition() {
    ...
    private List<IHatchElement<? super test_machines>> getAllowedHatches() {
